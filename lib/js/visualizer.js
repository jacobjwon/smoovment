...
Visualizer.prototype = {
  ...
  _start: function() {
    ...
    fr.onload = function(e) {
      ...
      that._updateInfo('uno momento por favor', true);
  ...
  _drawSpectrum: function(analyser) {
    ...
    gradient.addColorStop(1, '#22316C');
    gradient.addColorStop(0.5, '#0CD7FD');
    gradient.addColorStop(0, '#f00');

    gradient2.addColorStop(1, '#22316C');
    ...
    var drawMeter = function() {
      ...
      for (var i = 0; i < meterNum; i++) {
        ...
        ctx1.fillRect(i * 12, cheight - value + capHeight, meterWidth, cheight);
      }
