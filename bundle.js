...
(0, _jquery2.default)(function () {
  ...
  (0, _jquery2.default)(".nav-option").mouseleave(function () {
    (0, _jquery2.default)(this).children("ul.menu").removeClass("open").addClass("closed");
  });

  (0, _jquery2.default)("ul.menu").click(function () {
    (0, _jquery2.default)(this).removeClass("open").addClass("closed");
  });
  ...
  (0, _jquery2.default)(".steal").click(function () {
    visualizer.playSample("./assets/music/steal-your-heart.mp3");
  });
  ...
  (0, _jquery2.default)(".cube").click(function () {
